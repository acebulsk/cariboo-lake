...
**Abstract:** Sub-bottom acoustic transects, surficial sediment and long core sediment collected from Cariboo Lake, British Columbia are analyzed to present a record of sediment accumulation over the Holocene. Acoustically penetrable sediment is observed in deep parts of the lake reaching a maximum thickness of 35 m with a estimated basal date of ~18.5 ka BP. A transition from massive to well-layered sediments is observed in the sub-bottom acoustic record around 10.5-9 ka BP. Fine clastic sediments produced from the glaciated headwaters are delivered though suspension from overcurrents into the lake which produce bimodal rhythmic layering of silt and clay sediments. Laminae couplets are inferred to be deposited annually according to two AMS radiocarbon dates and a varve counting chronology. Two long cores, 2.9 and 3.8 m in length, were selected for analysis with estimated basal dates of ~2 ka BP. The accumulation of sediment into Cariboo Lake shows above average rates between 0-700CE and 1500-2017CE which are coincident with cool temperatures and peak glacier extents. The sediment chronology presented in this study contributes to the existing body of knowledge of lake sediment accumulation and Holocene watershed activity in western Canada. 
...
Environmental proxies that extend back beyond the modern observable record are crucial to understanding earth system processes [@Turney2019; @Huber2012; @Nelson2016]. Proxy reconstructions at the sub-annual scale (e.g. ice cores, tree rings, and corals), to multi-decadal scales (e.g. sediments, pollen, boreholes) have proven useful in describing past environmental conditions across the globe [@Masson2013]. Sedimentary sequences collected from glaciated watersheds have been important in contributing to regional understanding of climate and hydrologic variability over the Holocene. Research by @Neukom2019 have utilized sedimentary sequences as part of larger paleolimnological collections to provide a reconstruction of temperature variability over the last 2000 years. In western Canada, recovered sedimentary sequences have been collected in the Coastal Mountains [@Menounos2008], St.Elias Mountains [@Crookshanks2008], Monashee Mountains [@Hodder2006], and Rocky Mountains [@Desloges1999]. A study of Quesnel Lake (272 km^2^) by @Gilbert2012 found late glacial and Holocene infill to be high around 10.4 ka BP and ceased around 8.4 ka BP. Trends in the Quesnel Lake sediment characteristics during smaller Holocene climate fluctuations were not observed as this lake and watershed represented a much larger and less climate sensitive sedimentary system. Previous studies on lakes in smaller watersheds with high glacier cover have had success relating sediment archives with high resolution depositional sequences (e.g. varves) to changes in regional temperature, precipitation patterns, and glacier extent over the Holocene [@Desloges1999; @Hodder2006; @Menounos2009b]. However, higher sediment accumulation due to large glacier extent can limit the temporal coverage of sediment cores. To fill the gap for a higher resolution sedimentary records that spans into the late Holocene period the study here was undertaken at the smaller Cariboo Lake (11 km^2^) located in the Cariboo Mountains in eastern-central British Columbia.  
...
The purpose of this research is to 1) establish an understanding of the mechanisms that control the production, connection, and transport of sediment into and within the Cariboo Lake basin, 2) assess the signal observed in the sediment characteristics of acoustic records and sediment cores, 3) compare the Cariboo Lake sediment record to regional climate proxies. 
