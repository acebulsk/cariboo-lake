...
**Abstract:** Sub-bottom acoustic transects, surficial sediment and long core sediment collected from Cariboo Lake, British Columbia are analyzed to present a record of sediment accumulation over the Holocene. Acoustically penetrable sediment is observed in deep parts of the lake reaching a maximum observable sediment package of 35 m or ~18.5 ka BP. A transition from massive to well-layerd sediments is observed in the sub-bottom acoustic record around 10.5-9 ka BP. Fine clastic sediments produced from the glaciated headwaters are delivered though suspension from overcurrents into the lake which produce bimodal rhythmic layering observed in the sediment cores. Laminae couplets are inferred to be deposited annually according to two AMS radiocarbon dates. Two long cores, 2.9 and 3.8 m in length, were selected for analysis which are presented here to have basal dates of ~2 ka BP. The accumulation of sediment into Cariboo Lake shows above average rates between 0-700CE and 1500-2017CE which are coincident with cool temperatures and peak glacier extents. The sediment chronology presented in this study contributes to the existing body of knowledge of lake sediment accumulation and Holocene watershed activity in western Canada. 
...
Sub-bottom acoustic records are investigated across Cariboo Lake to determine sediment accumulation at coarse temporal resolution. Acoustically penetrible well-layered sediment is observed, in deep sub-basins of Cariboo Lake over 30 m deep. A transition of massive to well-layered sediments occurs around 10.5 to 9 ka BP, the timing of this transition is estimated using sediment rates derived from the Cariboo Lake long cores.  
