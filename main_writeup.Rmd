...
High accumulation rates in contemporary ice-contact lakes with extensive coverage of active glaciers have been observed to be between 0.5 m/a [@Crookshanks2008] and as high as 1 m/a [@Gilbert1997]. Similar high accumulation rates are inferred to have occurred in Quesnel Lake resulting in the thick pre-Holocene sediment package observed in @Gilbert2012. This evidence of high pre/early Holocene accumulation rates for Quesnel Lake from large dynamic glaciers suggests that high accumulation rates are also likely for Cariboo Lake during this time.

Warming in the early Holocene, around 9.10-6.70 ka BP in the Rockies, specifically, [@Luckman1986] and British Columbia, generally, [@Clague1989] lead to two possible sedimentation regimes. Where glaciers persist through the warm period resulting in more regular seasonality of sediment inputs and laminae couplet formation (e.g. Mud Lake) and where glaciers disappear during the warm period, leading to much lower accumulation and seasonality. 

Sub-bottom acoustic records from Transect B shown in Figure \@ref(fig:acoustics), which is proximal to the V1 core, indicate an upward transition from massive-unlayered (facies A) to well-layered sediments (facies B). The regular seasonally derived laminae couplets observed in the Cariboo Lake sediment package throughout the Holocene suggests that glaciers reduced in extent at the start of the Holocene but did not disappear completely. 

Assuming a maximum Holocene sediment accumulation rate of approximate 1.9 mm/yr from V1, this would put this transition at about 10.5 ka BP. Transect C, shown in Figure \@ref(fig:acoustics) is located in-between cores V1 and V2, has ~ 15 m of well layered sediment overlying a massive unlayered lower facies A. Using a combined V1 and V2 average Holocene sediment accumulation rate of 1.7 mm/yr in this region of the lake puts the transition from facies A to B at around 9 ka BP. If sediment delivery was less prior to the Neoglacial, the estimated basal ages here would be much older. The timing of this transition is similar to the onset of deglaciation and start of the Holocene sediment package within Mud Lake, BC [@Hodder2006] around 9.6 ka BP, at Moose Lake, BC [@Desloges1999] around 10.3 ka BP, at Quesnel Lake, BC [@Gilbert2012] around 8.6 ka BP, and at the Upper Bow River, AB [@Leonard1999] around 11.7 ka BP. 
...
Sub-bottom acoustic records were analyzed to provide a coarse temporal resolution chronology of Holocene sediment accumulation. Acoustically penetrable well-layered sediment is observed in deep sub-basins of Cariboo Lake over 30 m deep. A transition of massive to well-layered sediments occurs around 10.5 to 9 ka BP, similar to other lakes in the region.
