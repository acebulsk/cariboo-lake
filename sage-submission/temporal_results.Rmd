...
ams_meta |> 
  knitr::kable(
    caption = "Cariboo Lake chronologic control points. Note that the 2-sigma and median ages shown here are based on IntCal13.\\label{tab:amsDates}",
