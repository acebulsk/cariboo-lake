...
# create linear model for secondary axis
...
v2_plot <- 
  ...
  # geom_line(aes(y = smooth)) +
    ...
    geom_text(aes(x = 2017 - v2_C14$year + 75, y = -1.75), label = "158 ± 40 yr. CE", vjust = 1) +
    xlab("Year (CE)") +
    ylab("VT Std. Dept.") +
    ylim(c(-2, 5)) +
    ggtitle("V2") +
...
ggsave("figs/V1_V2_varvethickness_together_vs_depth_and_C14_est_yr_ma.png", vt_plot,  width = 8.5, height = 4)
saveRDS(vt_plot, "figs/V1_V2_varvethickness_together_vs_depth_and_C14_est_yr_ma.rds")
